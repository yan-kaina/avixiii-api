"""
Django settings for avixiii project.
...
SECRET_KEY = 'django-insecure-)$!m6-xs^0fbw*nhu#j&tu!6=ln-s)x4ch@k)ahiqy-&r_lq5v'
...
WSGI_APPLICATION = 'avixiii.wsgi.application'
